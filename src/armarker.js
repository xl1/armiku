(function() {
  var $, IDMAT4, Vec3, detector, get, gl, glHeight, glWidth, init, loadModels, main, makeModelViewMatrix, makePerspective, makeTransformMatrix, models, perspective, showMarker, update, videoModel, webcam;
  IDMAT4 = function() {
  ...
  /* 毎フレーム呼ばれる */
  update = function() {
    var m, marker, markers, _i, _j, _len, _len2;
    gl.clear();
    gl.bindVars({
  ...
  main = function() {
    ...
    return get('miku.obj.json', function(text) {
